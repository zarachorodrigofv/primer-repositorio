...
if (empty($modsUser['maquinaria'])) {
    http_response_code(403);
    echo "<p style='text-align:center;margin-top:40px;font-family:sans-serif'>No tenés cursos de la modalidad Maquinaria/Mecánica asignados.</p>";
    exit;
}

$cursos = cursosPorRolYModalidad($rol, $dni, $yearId, 'maquinaria');
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Técnico en Maquinaria - S.G.I</title>
