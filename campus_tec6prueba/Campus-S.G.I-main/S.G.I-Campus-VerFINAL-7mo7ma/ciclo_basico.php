...
if (empty($modsUser['cb'])) {
    http_response_code(403);
    echo "<p style='text-align:center;margin-top:40px;font-family:sans-serif'>No tenés cursos en Ciclo Básico asignados.</p>";
    exit;
}

$cursos = cursosPorRolYModalidad($rol, $dni, $yearId, 'cb');
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Ciclo Básico - S.G.I</title>
  ...
  <div class="grid">
    <?php if (empty($cursos)): ?>
      <p style="grid-column:1/-1;text-align:center;margin-top:20px;">
        No tenés cursos de Ciclo Básico asignados para este año.
      </p>
    <?php else: ?>
